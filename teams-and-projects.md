...
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 04.03 до — ОО-дизайн v1 (CRC-карточки) | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) |  |
