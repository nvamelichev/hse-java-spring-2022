...
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 16.04 <br> &ndash; Последнее мелкое исправление UML-диаграммы классов. См. комментарий к [java-cell-auto-sim#6](https://github.com/DosBall/java-cell-auto-sim/issues/6#issuecomment-1100641612) <br> 22.04 &mdash; Первый релиз (долг) <br> 29.04 &mdash; Второй релиз | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | | &minus;0.05 за пропуск первого демо-дня |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 16.04 &mdash; Поправить последние штрихи по UML-диаграммам. См. [комментарий к hse-java-2022-calc#3](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/3#issuecomment-1100644519) <br> 22.04 &mdash; Первый релиз (долг) <br> 29.04 &mdash; Второй релиз | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) | | &minus;0.05 за пропуск первого демо-дня |
