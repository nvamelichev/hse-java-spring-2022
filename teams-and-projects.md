...
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 18.02 — Проектная документация v2, см. [Console-Organizer#1](https://github.com/mr1er0y/Console-Organizer/issues/1) и [Console-Organizer#2](https://github.com/mr1er0y/Console-Organizer/issues/2) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
...
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил(@roopeer), <br> Андрей Козлов(@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 18.02 &mdash; Проектная документация v2, см. [roguelike#1](https://github.com/elevankoff/roguelike/issues/1) | [roguelike](https://github.com/elevankoff/roguelike) |  |
