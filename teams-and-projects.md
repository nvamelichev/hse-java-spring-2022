...
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | **Проект сдан!** | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | &minus;0.05 за пропуск первого демо-дня <br> +0.05 за реализацию всех User Story во втором релизе <br> &minus;0.05 за пропуск четвёртого демо-дня | 0.55 |
