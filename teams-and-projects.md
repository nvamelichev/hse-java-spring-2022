...
| Команда | Проект | Ближайший дедлайн | GitHub | Примечания | Бонусы и штрафы | Оценка за проект |
| ------- | ------ | ----------------- | ------ | ---------- | --------------- | ---------------- |
| Зиннурова Диана (@dianissimo_z), <br> Петров Олег (@pauchara0), <br> Бордюгов Максим (@DedAzaMarks), <br> Каледин Андрей (@kaledin_andrew), <br> Сергей Стриженок (@sstrizhenok) | Крестики-нолики онлайн: REST-сервис + консольный клиент к нему* | 03.06 &mdash; Четвёртый релиз, см. [TicTacToeOnline#13](https://github.com/kaledinandrew/TicTacToeOnline/issues/13) | [TicTacToeOnline](https://github.com/kaledinandrew/TicTacToeOnline) | <details><summary>* Проект повышенной трудности</summary>* Крупная и опытная команда, поэтому scope проекта будет больше, чем у остальных <br> * Опыт бэкенд-разработки есть у Максима, Андрея и Сергея <br> * Web UI не будет, поэтому HTML/CSS/Javascript, к счастью, остаются за бортом</details> | +0.1 за проект повышенной сложности <br> +0.05 за доп способ сборки (native-image) <br> +0.05 за публикацию в Dockerhub | 0.8 |
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 03.06 &mdash; Четвёртый релиз, см. [discraft#12](https://github.com/NanamyYu/discraft/issues/12) | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности | +0.1 за проект повышенной трудности <br> &minus;0.05 за пропуск первого демо-дня <br> +0.05 за реализацию всех User Story во втором релизе <br> +0.05 за публикацию в Dockerhub | 0.75 |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 03.06 &mdash; Четвёртый релиз, см. [Console-Organizer#15](https://github.com/mr1er0y/Console-Organizer/issues/15) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) |  | |
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 03.06 &mdash; Четвёртый релиз, см. [PROJECT-Short_Text_Generator#6](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/6) | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | | &minus;0.05 за пропуск первого демо-дня <br> +0.05 за реализацию всех User Story во втором релизе | |
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 03.06 &mdash; Четвёртый релиз, см. [metadata-extractor-java#20](https://github.com/Placebo900/metadata-extractor-java/issues/20) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) |  | |
| Леванков Егор (@elevankoff), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра* | **Всё! Проект сдан :-)** | [roguelike](https://github.com/elevankoff/roguelike) | * Проект повышенной трудности | +0.1 за проект повышенной трудности <br> &minus;0.05 за пропуск второго демо-дня <br> &minus;0.05 за пропуск третьего демо-дня | 0.6 |
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 03.06 &mdash; Четвёртый релиз, см. [java-cell-auto-sim#7](https://github.com/DosBall/java-cell-auto-sim/issues/7) | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | | &minus;0.05 за пропуск первого демо-дня <br> &minus;0.05 за пропуск третьего демо-дня | |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 20.05 &mdash; Третий релиз, см. [hse-java-2022-calc#7](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/7) | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) | | &minus;0.05 за пропуск первого демо-дня <br> &minus;0.05 за пропуск третьего демо-дня | |
