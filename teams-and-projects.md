...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 10.06 &mdash; Исправления замечаний к четвёртому релизу,  см. [metadata-extractor-java#20](https://github.com/Placebo900/metadata-extractor-java/issues/20) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | &mdash; | &mdash; |
