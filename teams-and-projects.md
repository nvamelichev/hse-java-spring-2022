...
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 22.03 &mdash; Исправление мелких замечаний по CRC-карточкам: [discraft#3](https://github.com/NanamyYu/discraft/issues/3), первая версия UML-диаграмм <br><br> 25.03 &mdash; Финальная версия ОО-дизайна: UML-диаграммы системы и CRC-карточки | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 22.03 &mdash; Улучшенные CRC-карточки с более чёткой декомпозицией системы на классы: [Console-Organizer#3](https://github.com/mr1er0y/Console-Organizer/issues/3), первая версия UML-диаграмм <br><br> 25.03 &mdash; Финальная версия ОО-дизайна: UML-диаграммы системы и CRC-карточки | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 22.03 &mdash; Исправление замечаний по CRC-карточкам и UML-диаграммам: [PROJECT-Short_Text_Generator#4](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/4) <br><br> 25.03 &mdash; Финальная версия ОО-дизайна: UML-диаграммы системы и CRC-карточки | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | |
