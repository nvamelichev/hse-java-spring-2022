...
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 05.04 &mdash; Исправленная и дополненная диаграмма классов. См. [ещё один комментарий к discraft#4](https://github.com/NanamyYu/discraft/issues/4#issuecomment-1086824689) | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 05.04 &mdash; Всё ещё жду UML-диаграмму, показывающую поведение системы (Sequence/State Machine/Activity). См. последний пункт в [комментарии к Console-Organizer#4](https://github.com/mr1er0y/Console-Organizer/issues/4#issuecomment-1083183697) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 05.04 <br> &ndash; Всё ещё жду последние исправления UML-диаграмм. См. [комментарий к metadata-extractor-java#4](https://github.com/Placebo900/metadata-extractor-java/issues/4#issuecomment-1083239130) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) |  |
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 05.04 &mdash; Всё ещё жду UML-диаграмму, показывающую хотя бы небольшую часть взаимодействия спроектированных ВАШИМИ классов ДРУГ С ДРУГОМ (Sequence/State Machine/Activity). Описывать взаимодействие с классами игрового фреймворка - **НЕ** надо. См. [комментарий к roguelike#3](https://github.com/elevankoff/roguelike/issues/3#issuecomment-1083209329) | [roguelike](https://github.com/elevankoff/roguelike) | |
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 05.04 <br> &ndash; Всё ещё жду исправленную версия CRC-карточек, см. [java-cell-auto-sim#5](https://github.com/DosBall/java-cell-auto-sim/issues/5) <br> Всё ещё жду UML-диаграммы системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | **Жду UML до 05.04 включительно** |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 05.04 <br> &ndash; Всё ещё жду исправленные CRC-карточки. См. [hse-java-2022-calc#3](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/3) <br> &ndash; Всё ещё жду первую версию UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) | **Жду пофикшенные CRC и первую версию UML до 05.04 включительно** |
