...
| ------- | ------ | ----------------- | ------ | ---------- |
| Зиннурова Диана (@dianissimo_z), <br> Петров Олег (@pauchara0), <br> Бордюгов Максим (@DedAzaMarks), <br> Каледин Андрей (@kaledin_andrew), <br> Сергей Стриженок (@sstrizhenok) | Крестики-нолики онлайн: REST-сервис + консольный клиент к нему | 25.03: <br> &ndash; Исправление последних замечаний по CRC-карточкам [TicTacToeOnline#8](https://github.com/kaledinandrew/TicTacToeOnline/issues/8#issuecomment-1072077727) <br> &ndash; Исправление замечаний по UML-диаграммам. <br> UML-диаграмма классов серверной части (хотя бы примерно). <br> UML-диаграммы, описывающие поведение системы [TicTacToeOnline#10](https://github.com/kaledinandrew/TicTacToeOnline/issues/10) | [TicTacToeOnline](https://github.com/kaledinandrew/TicTacToeOnline) | <details><summary>* Проект повышенной трудности</summary>* Крупная и опытная команда, поэтому scope проекта будет больше, чем у остальных <br> * Опыт бэкенд-разработки есть у Максима, Андрея и Сергея <br> * Web UI не будет, поэтому HTML/CSS/Javascript, к счастью, остаются за бортом</details> |
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 25.03 <br> &ndash; Исправление мелких замечаний по CRC-карточкам: [discraft#3](https://github.com/NanamyYu/discraft/issues/3) <br> &ndash; Первая версия UML-диаграмм, она же последняя | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 25.03 <br> &ndash; Улучшенные CRC-карточки с более чёткой декомпозицией системы на классы: [Console-Organizer#3](https://github.com/mr1er0y/Console-Organizer/issues/3) <br> &ndash; Первая версия UML-диаграмм, она же последняя. Нужны и диаграмма классов, и ещё хотя бы одна динамическая диаграмма (Sequence, State Machine, Activity) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 25.03 <br> &ndash; Исправление замечаний по CRC-карточкам и UML-диаграммам, в т.ч. заменить не очень интересную State Machine диаграмму на более содержательную Sequence: [PROJECT-Short_Text_Generator#4](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/4) | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | |
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 25.03 <br> &ndash; Первая, она же последняя версия UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | |
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 25.03 <br> &ndash; Первая, она же последняя версия CRC-карточек и UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [roguelike](https://github.com/elevankoff/roguelike) |  |
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 25.03 <br> &ndash; Первая, она же последняя версия CRC-карточек и UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) |  |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 25.03 <br> &ndash; Исправленные CRC-карточки [hse-java-2022-calc#3](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/3) <br> &ndash; Первая, она же последняя версия UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) |  |
