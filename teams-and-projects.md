...
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax) | 2. Консольный органайзер | 02.02 &mdash; Создать репозиторий <br> 11.02 — Проектная документация | TBD | |
