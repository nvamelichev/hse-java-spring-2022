...
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 15.04 <br> &ndash; Последние исправления UML-диаграмм. См. комментарий к [java-cell-auto-sim#6](https://github.com/DosBall/java-cell-auto-sim/issues/6#issuecomment-1098381633) <br> &ndash; Первый релиз! | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) |  |
