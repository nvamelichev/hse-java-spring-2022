...
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | TBD | 02.02 &mdash; Выбрать тему проекта и создать репозиторий | TBD | |
| Сальков Леонид (@Mr_Leroy), <br> Неминская Софья (@neminskaia), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax) | 2. Консольный органайзер | 02.02 &mdash; Создать репозиторий <br> 11.02 — Проектная документация | TBD | |
...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | TBD | 02.02 &mdash; Создать репозиторий <br> 11.02 &mdash; Проектная документация | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | |
