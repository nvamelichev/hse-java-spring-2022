...
| Леванков Егор (@elevankoff), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра* | 03.06 &mdash; Четвёртый релиз, см. [roguelike#11](https://github.com/elevankoff/roguelike/issues/11) | [roguelike](https://github.com/elevankoff/roguelike) | * Проект повышенной трудности | +0.1 за проект повышенной трудности <br> &minus;0.05 за пропуск второго демо-дня <br> &minus;0.05 за пропуск третьего демо-дня |
