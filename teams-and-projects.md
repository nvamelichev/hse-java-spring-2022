...
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 16.03 &mdash; Исправленные CRC-карточки (см. [PROJECT-Short_Text_Generator#3](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/3)) <br> 18.03 &mdash; Первая версия UML-диаграмм системы | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | |
