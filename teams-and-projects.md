...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 22.03 &mdash; Первая версия UML-диаграмм системы <br><br> 25.03 &mdash; Финальная версия ОО-дизайна: UML-диаграммы системы и CRC-карточки | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | |
