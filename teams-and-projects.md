...
| Сальков Леонид (@Mr_Leroy), <br> Неминская Софья (@neminskaia), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax) | TBD | 02.02 &mdash; Выбрать тему проекта и создать репозиторий | TBD | |
