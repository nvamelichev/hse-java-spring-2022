...
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 01.04 <br> Последние исправления по диаграмме классов. UML-диаграмма, показывающая поведение системы (Sequence/State Machine/Activity). См. [комментарий к Console-Organizer#4](https://github.com/mr1er0y/Console-Organizer/issues/4#issuecomment-1083183697) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
