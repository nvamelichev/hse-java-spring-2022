...
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | <br> 22.03 — Первая версия CRC-карточек и UML-диаграмм <br><br> 25.03 &mdash; Финальная версия ОО-дизайна: UML-диаграммы системы и CRC-карточки | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) |  |
