...
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 08.04 &mdash; Всё ещё жду UML-диаграмму, показывающую поведение системы (Sequence/State Machine/Activity). См. последний пункт в [комментарии к Console-Organizer#4](https://github.com/mr1er0y/Console-Organizer/issues/4#issuecomment-1083183697) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | **Жду UML Sequence/Activity/State Machine до 08.04 включительно** |
...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 08.04 <br> &ndash; Всё ещё жду последние исправления UML-диаграмм. См. [комментарий к metadata-extractor-java#4](https://github.com/Placebo900/metadata-extractor-java/issues/4#issuecomment-1083239130) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | **Жду пофикшенные UML-диаграммы до 08.04 включительно** |
