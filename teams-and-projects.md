...
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 17.06 &mdash; Исправления замечаний к четвёртому релизу, см. [java-cell-auto-sim#7](https://github.com/DosBall/java-cell-auto-sim/issues/7) | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | &minus;0.05 за пропуск первого демо-дня <br> &minus;0.05 за пропуск третьего демо-дня | &mdash; |
...
- **Четвёртый релиз:** дедлайн **03.06** (четвёртый, последний демо-день)
  ...
  - [ ] (необязательно; бонус +0.05): Настроена сборка проекта из ветки `main` в исполняемый артефакт (докер-образ, native-image, jlink/jpackage), причём:
  ...
  - [ ] (необязательно; бонус +0.05): Проект собирается в несколько исполняемых артефактов сразу, например, и в Docker-контейнер, и в native-image.
----
</details>
