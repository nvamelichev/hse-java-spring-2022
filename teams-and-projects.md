...
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | **Проект выполнен примерно на 2/3 и оценка выставлена соответственно** | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | &minus;0.05 за пропуск первого демо-дня <br> &minus;0.05 за пропуск третьего демо-дня | 0.4 |
