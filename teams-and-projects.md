...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 10.06 &mdash; Исправления замечаний к четвёртому релизу,  см. [metadata-extractor-java#20](https://github.com/Placebo900/metadata-extractor-java/issues/20) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) |  | &mdash; |
| Леванков Егор (@elevankoff), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра* | **Проект сдан :-)** | [roguelike](https://github.com/elevankoff/roguelike) | * Проект повышенной трудности | +0.1 за проект повышенной трудности <br> &minus;0.05 за пропуск второго демо-дня <br> &minus;0.05 за пропуск третьего демо-дня | 0.6 |
