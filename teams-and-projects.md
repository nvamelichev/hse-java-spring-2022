...
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 16.02 &mdash; User Stories v1!!! <br> 18.02 &mdash; Проектная документация v2, см. [discraft#1](https://github.com/NanamyYu/discraft/issues/1) | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 16.02 — User Stories v1!!! <br> 18.02 — Проектная документация v2, см. [Console-Organizer#1](https://github.com/mr1er0y/Console-Organizer/issues/1) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
...
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил(@roopeer), <br> Андрей Козлов(@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 16.02 &mdash; Проектная документация v1!!! | [roguelike](https://github.com/elevankoff/roguelike) | :-( Пустой репозиторий (по состоянию на 2022-02-14) |
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 16.02 — Проектная документация v1!!! | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | Нет проектной документации ни на вики, ни файлами (по состоянию на 2022-02-14) |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 16.02 — User Stories v1!!! <br> 18.02 — Проектная документация v2, см. https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/1 | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) | |
