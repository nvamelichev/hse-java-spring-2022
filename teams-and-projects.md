...
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 22.03 &mdash; Первая версия CRC-карточек и UML-диаграмм <br><br> 25.03 &mdash; Финальная версия ОО-дизайна: UML-диаграммы системы и CRC-карточки | [roguelike](https://github.com/elevankoff/roguelike) |  |
