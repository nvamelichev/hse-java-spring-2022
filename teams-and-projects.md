...
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 22.04 &mdash; Поправить последние штрихи по UML-диаграммам. См. [комментарий к hse-java-2022-calc#3](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/3#issuecomment-1100644519) <br> 29.04 &mdash; Второй релиз (показать **ВСЁ** по первому И второму релизу) | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) | | &minus;0.05 за пропуск первого демо-дня |
