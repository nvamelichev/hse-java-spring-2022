...
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил(@rooper), <br> Андрей Козлов(@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 16.02 &mdash; Проектная документация v1!!! | [roguelike](https://github.com/elevankoff/roguelike) | :-( Пустой репозиторий (по состоянию на 2022-02-14) |
