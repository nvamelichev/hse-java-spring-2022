...
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 28.03 &mdash; Исправленная и дополненная диаграмма классов. Диаграмма, описывающая поведения системы (Sequence/State Machine/Activity). См. [discraft#4](https://github.com/NanamyYu/discraft/issues/4) | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности |
