...
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 15.04 <br> &ndash; Поправить последние штрихи по UML-диаграммам. См. [комментарий к hse-java-2022-calc#3](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/3#issuecomment-1098358460) <br> &ndash; Первый релиз! | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) |  |
