...
| ------- | ------ | ----------------- | ------ | ---------- |
| Зиннурова Диана (@dianissimo_z), <br> Петров Олег (@pauchara0), <br> Бордюгов Максим (@DedAzaMarks), <br> Каледин Андрей (@kaledin_andrew), <br> Сергей Стриженок (@sstrizhenok) | Крестики-нолики онлайн: REST-сервис + консольный клиент к нему | 16.03 &mdash; Исправленные и дополненные CRC-карточки (см. [TicTacToeOnline#8](https://github.com/kaledinandrew/TicTacToeOnline/issues/8)) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы  | [TicTacToeOnline](https://github.com/kaledinandrew/TicTacToeOnline) | <details><summary>* Проект повышенной трудности</summary>* Крупная и опытная команда, поэтому scope проекта будет больше, чем у остальных <br> * Опыт бэкенд-разработки есть у Максима, Андрея и Сергея <br> * Web UI не будет, поэтому HTML/CSS/Javascript, к счастью, остаются за бортом</details> |
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 16.03 &mdash; ОО-дизайн v1 (CRC-карточки) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы  | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 16.03 — ОО-дизайн v1 (CRC-карточки) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы  | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | |
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 16.03 &mdash; Исправленные CRC-карточки (см. [PROJECT-Short_Text_Generator#3](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/3)) <br> 11.03 &mdash; Первая версия UML-диаграмм системы | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | |
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 16.03 &mdash; Исправленные CRC-карточки(см. [metadata-extractor-java#3](https://github.com/Placebo900/metadata-extractor-java/issues/3)) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы  | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | |
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 16.03 &mdash; ОО-дизайн v1 (CRC-карточки) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы  | [roguelike](https://github.com/elevankoff/roguelike) |  |
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 16.03 — ОО-дизайн v1 (CRC-карточки) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) |  |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | <br> 16.03 — ОО-дизайн v1 (CRC-карточки) <br> 18.03 &mdash; Вторая версия CRC-карточек. Первая версия UML-диаграмм системы | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) |  |
...
Предстоящие:
- **Высокоуровневой объектно-ориентированный дизайн** (CRC-карточки): **18.03** вторая версия, **18.03** окончательная версия
