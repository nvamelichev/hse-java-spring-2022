...
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv) | TBD | 02.02 &mdash; Выбрать тему и создать репозиторий | TBD | |
| Илья Сизов (@sizovjr), <br> Алексей Голенков (@Golenkov1) | TBD | 02.02 &mdash; Выбрать тему и создать репозиторий | TBD | |

Вне команд (на курс не записан, проект не берёт, только смотрит зум с практиками):
* @dimitry
