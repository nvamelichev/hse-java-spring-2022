...
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 25.03 <br> &ndash; Последняя версия UML-диаграмм системы, включая диаграмму классов, которой сейчас нет. **Список замечаний опубликую в четверг 24.03** | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | |
