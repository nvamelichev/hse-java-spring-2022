...
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 28.03 <br> &ndash; Исправление мелких замечаний по UML-диаграммам. См. [комментарий к PROJECT-Short_Text_Generator#4](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/4#issuecomment-1079728251) | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | |
