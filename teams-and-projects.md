...
| ------- | ------ | ----------------- | ------ | ---------- |
| Зиннурова Диана (@dianissimo_z), <br> Петров Олег (@pauchara0), <br> Бордюгов Максим (@DedAzaMarks), <br> Каледин Андрей (@kaledin_andrew), <br> Сергей Стриженок (@sstrizhenok) | Крестики-нолики онлайн: REST-сервис + консольный клиент к нему | 25.03: <br> &ndash; Исправление последних замечаний по CRC-карточкам. См. [TicTacToeOnline#8](https://github.com/kaledinandrew/TicTacToeOnline/issues/8#issuecomment-1072077727) <br> &ndash; Исправление замечаний по UML-диаграммам; добавить UML-диаграмму классов серверной части (хотя бы примерную); добавить хотя бы одну UML-диаграмму, описывающую поведение системы. См. [TicTacToeOnline#10](https://github.com/kaledinandrew/TicTacToeOnline/issues/10) | [TicTacToeOnline](https://github.com/kaledinandrew/TicTacToeOnline) | <details><summary>* Проект повышенной трудности</summary>* Крупная и опытная команда, поэтому scope проекта будет больше, чем у остальных <br> * Опыт бэкенд-разработки есть у Максима, Андрея и Сергея <br> * Web UI не будет, поэтому HTML/CSS/Javascript, к счастью, остаются за бортом</details> |
| Алиса Гареева (@gareeva_aa), <br> Серёжа Рахманов (@shoraiixyz), <br> Лиза Шатская (@NanamyYu) | Плагин для сервера Minecraft, который добавляет авторизацию через Discord* | 25.03 <br> &ndash; Исправление мелких замечаний по CRC-карточкам. См. [discraft#3](https://github.com/NanamyYu/discraft/issues/3) <br> &ndash; Первая, она же последняя версия UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [discraft](https://github.com/NanamyYu/discraft) | * Проект повышенной трудности <br> * **Первый показ UML** |
| Сальков Леонид (@Mr_Leroy), <br> Крапивина Мария (@itoyaaa), <br> Конюх Александр (@snorIax), <br> Новиков Георгий (@gosha22397) | 2. Консольный органайзер | 25.03 <br> &ndash; Улучшенные CRC-карточки с более чёткой декомпозицией системы на классы. См. [Console-Organizer#3](https://github.com/mr1er0y/Console-Organizer/issues/3) <br> &ndash; Первая, она же последняя версия UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [Console-Organizer](https://github.com/mr1er0y/Console-Organizer) | **Первый показ UML** |
| Березовский Валерий (@jeembogod), <br> Городилова Анастасия (@nastygorodi) | 9. Генератор коротких текстов (как Яндекс.Рефераты, но для заголовков FAKE NEWS!!!) | 25.03 <br> &ndash; Исправление замечаний по CRC-карточкам и UML-диаграммам, в т.ч. заменить не очень интересную State Machine диаграмму на более содержательную Sequence. См. [PROJECT-Short_Text_Generator#4](https://github.com/nastygorodi/PROJECT-Short_Text_Generator/issues/4) | [PROJECT-Short_Text_Generator](https://github.com/nastygorodi/PROJECT-Short_Text_Generator) | |
| Бекетов Никита Дмитриевич (@try2becareful), <br> Курбанов Рустам Шамилевич (@vkontaktekruto), <br> Турчанинов Михаил Валерьевич (@FANCYoj), <br> Захаров Никита (@nick_nerd)  | 1. Экстрактор метаданных и текста из файлов для быстрого поиска | 25.03 <br> &ndash; Исправленная и дополненная последняя версия UML-диаграмм системы, включая диаграмму классов, которой сейчас нет. См. [metadata-extractor-java#4](https://github.com/Placebo900/metadata-extractor-java/issues/4) | [metadata-extractor-java](https://github.com/Placebo900/metadata-extractor-java) | |
| Леванков Егор (@YegorLevankov), <br> Пантелеев Даниил (@roopeer), <br> Андрей Козлов (@Andrew_D_Kozlov), <br> Алексей Голенков (@Golenkov1) | 10. Простая Roguelike-игра с текстовым интерфейсом | 25.03 <br> &ndash; Первая, она же последняя версия CRC-карточек и UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [roguelike](https://github.com/elevankoff/roguelike) | **Одновременный первый показ CRC и UML!!!** |
| Кайралап Досбол (@DosBall), <br> Калкаманов Илияс (@ikalkamanov), <br> Ярусский Илья (@Ilyarusish) | 8. Симулятор клеточных автоматов | 25.03 <br> &ndash; Первая, она же последняя версия CRC-карточек и UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [java-cell-auto-sim](https://github.com/DosBall/java-cell-auto-sim) | **Одновременный первый показ CRC и UML** |
| Семён Степанов (@seemsgoood), <br> Василий Вялков (@vslvlkv), <br> Илья Сизов (@sizovjr), <br> Рябов Николай (@ry461ch) | 4. RPN-калькулятор (Модульный) | 25.03 <br> &ndash; Исправленные CRC-карточки. См. [hse-java-2022-calc#3](https://github.com/AndroidM0nkey/hse-java-2022-calc/issues/3) <br> &ndash; Первая, она же последняя версия UML-диаграмм системы (статической Class и 1+ динамических (Sequence, State Machine, Activity)) | [hse-java-2022-calc](https://github.com/AndroidM0nkey/hse-java-2022-calc) | **Первый показ UML** |
